...
// Definimos el arreglo de navegación con los elementos del menú
const navigation = [
...
// Explicación sobre `map()`
// El método `map()` recorre el arreglo `navigation`, creando dinámicamente una lista `<li>`
// con los elementos del menú. Cada objeto del array se transforma en un `<li>` con un `<a>`
// dentro, adaptando estilos según la propiedad `available`.
